 ...
 */
@Deprecated
public class OldGridFlow implements Iterable<Triple<Integer,Integer,Double>>{
    HashSet<Triple<Integer, Integer, Double>> entries = new HashSet<>();
    int[] grid_dimensions;
    int n;
    int m;
    
    public OldGridFlow(GridGraph g){
        this.grid_dimensions = g.nodesPerDim;
        this.n = g.getN();
        calculateM();
    }
    private OldGridFlow(OldGridFlow f, boolean clone){
    ...
    public OldGridFlow gradient_lmax(){
        double sum_exps = lmax_exp();
        OldGridFlow f = new OldGridFlow(this, false);
    ...
    public OldGridFlow scale(double d) {
        OldGridFlow cl = new OldGridFlow(this, true);
        for(Triple<Integer, Integer, Double> t : cl.entries){
            t.c = t.c * d;
        }
        return cl;
    }
    public static OldGridFlow add(OldGridFlow a, OldGridFlow b) {
        OldGridFlow cl = new OldGridFlow(a, true);
